class Carrossel { 
  ...
  constructor(obj){
    ...
    this._moveLeft = document.createElement("img");
    this._moveRight = document.createElement("img");
  ...
  createMoveElements(){
    this._moveLeft.src = "https://www.flaticon.com/svg/vstatic/svg/271/271220.svg?token=exp=1618734643~hmac=f31284b337b8266f76500517da424518"
    this._moveLeft.classList.add("__carrossel-move");
    ...
    this._moveRight.src = "https://www.flaticon.com/svg/vstatic/svg/271/271228.svg?token=exp=1618734638~hmac=24aa6719e9909404d598dc7cef4afb3e"
    this._moveRight.classList.add("__carrossel-move");
