var controllers = {
  ...
  renderAllProducts: function() {
    ...
    for(var i=0; i<products.length; i++) {
      ...
      imgContainer.classList.add("product-item-img");
      var carrossel = new Carrossel({el: imgContainer, images: product.images});
      elBox.appendChild(imgContainer);
      // this.renderImages(elBox, product.images); //metodo da aula 10 de passar só a img

      var spaceBtw = document.createElement("div");
      this.setStyle(spaceBtw, {
        display: "flex",
        flex: "1 0",
      });
      elBox.appendChild(spaceBtw);
